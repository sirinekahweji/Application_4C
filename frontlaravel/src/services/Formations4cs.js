...
export default {
    ...
    GetParticipation(UserId,EventId) {
        return Axios.get(`/Formation4c/GetParticipation/${UserId}/${EventId}`);
    },

    Participer(UserId,EventId) {
        return Axios.post(`/Formation4c/Participer/${UserId}/${EventId}`);
    },

    AnnulerParticiper(UserId,EventId) {
        return Axios.delete(`/Formation4c/AnnulerParticiper/${UserId}/${EventId}`);
    },
};
