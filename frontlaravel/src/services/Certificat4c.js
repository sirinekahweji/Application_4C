...
export default {
    ...
    GetParticipation(UserId,EventId) {
        return Axios.get(`/Certificat4c/GetParticipation/${UserId}/${EventId}`);
    },

    Participer(UserId,EventId) {
        return Axios.post(`/Certificat4c/Participer/${UserId}/${EventId}`);
    },

    AnnulerParticiper(UserId,EventId) {
        return Axios.delete(`/Certificat4c/AnnulerParticiper/${UserId}/${EventId}`);
    },
};
