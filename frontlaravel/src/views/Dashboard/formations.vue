                    ...
                    <div class=" modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Ajouter Formation</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form @submit.prevent="addNewFormation">
                                    <div class="row">
                                        <!-- Partie gauche du formulaire -->
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="nom" class="form-label">Nom de Formation</label>
                                                <input type="text" v-model="formation.titre" class="form-control"
                                                    id="nom" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="date" class="form-label">Date</label>
                                                <input type="date" v-model="formation.dateLimiteInscription"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" v-model="formation.categorie" class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="nbSession" class="form-label">Nombre de Session </label>
                                                <input type="text" v-model="formation.nbSession" class="form-control"
                                                    id="nbSession" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="formateur" class="form-label">Formateur </label>
                                                <input type="text" v-model="formation.formateur" class="form-control"
                                                    id="formateur" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="capacite" class="form-label">Capacite </label>
                                                <input type="text" v-model="formation.capacite" class="form-control"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input type="radio" id="categorieInput0" value="1"
                                                        v-model="formation.forManagers" class="form-check-input">
                    ...
                    <div class="filter-bar">
                        <div class="filter-bar">
                            <div class="search-container">
                                ...
                                <input type="text" class="search-input" placeholder="Chercher Formation..."
                                    v-model="searchQuery">
                            </div>
                            <div class="bt">
...
import event from '@/components/Dashboard/dashboard/formationAdmin.vue'
import 'sweetalert2/dist/sweetalert2.min.css';
import Swal from 'sweetalert2'
import formations4cService from "@/services/formations4c";
import Formations4cService from "@/services/Formations4cs";
...
export default {
    ...
    methods: {
        addNewFormation() {
            ...
            if (imageFiles.length > 0) {
                ...
                reader.onload = (e) => {
                    ...
                    this.formation.affiche = imageSrc;
                    //console.log(this.certif);

                    Formations4cService.addFormation4c(this.formation).then(() => {
                        this.formation = {
                            titre: null,
                            nbSession: null,
                            formateur: null,
        ...
        validerCreation() {
            Swal.fire({
                title: "Validé !",
                text: "Votre formation a été créée !",
                icon: "success",
            }).then((result) => {
        ...
        getFormations() {
            formations4cService.getAll().then((res) => {
