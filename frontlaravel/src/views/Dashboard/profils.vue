        ...
        <div class="wrapper">
            <div class="menu">
                ...
                <ul class="fils">
                    ...
                    <li>
                        <a @click="changerView('profiles')"><img src="@/assets/etudiant.png" alt="Profils">
                            Profils</a>
                    </li>
                    <li>
                        ...
                        <div class="filter-bar">
                            <div class="bt">
                                ...
                                <select class="select" v-model="selectedRole">
                                    ...
                                    <option v-for="(role, index) in roles" :key="index" :value="role.id">{{ role.nomRole
                                        }}
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="buttons-right">
                                <button class="download-button" @click="voirHistorique()"><i
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="(profil, index) in displayedItems" :key="index">
                                    ...
                                    <td>{{ roles[profil.role_id - 1] ? roles[profil.role_id - 1].nomRole : 'non trouvé'
                                        }}
                                    </td>
                                    <td>
...
export default {
    ...
    methods: {
        voirHistorique() {
            router.push('/Dashboard/profils/historique');
        },
        changerView(msg) {
            if (msg === 'acces') {
        ...
        getProfils() {
            UserService.getAll().then((res) => {
                this.profils = res.data.data.filter(profil => !profil.corbeille);
            })
        },
