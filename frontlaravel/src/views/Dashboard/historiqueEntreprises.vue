...
export default {
    ...
    methods: {
        ...
        async telechargerPDF() {
            this.loading = true;
            const doc = new jsPDF();
            doc.text('Liste des Entreprises archivées', 10, 10);
        ...
        async imprimerPDF() {
            this.loading = true;
            const doc = new jsPDF();
            doc.text('Archive des entreprises', 10, 10);
            const profils = this.entreprises;
        ...
        getEntreprises() {
            EntrepriseService.getEntreprisesHistorique().then((res) => {
