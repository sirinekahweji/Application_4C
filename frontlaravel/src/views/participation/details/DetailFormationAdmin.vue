    ...
    <div>
        ...
        <section >
            <div class="row" style="margin-right: 0px;">
                <div class="col-md-3" style="max-width: 300px;">
                    <div class="menu">
                        ...
                        <ul class="fils">
                            ...
                            <li>
                                <a @click="changerView('attestations')"><img src="@/assets/attestation.png"
                                        alt="Attestations">
                                    Attestations</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a @click="changerView('formations')"><img src="@/assets/formation.png"
                                        alt="Formations">
                                    Formations</a>
                            </li>
                            <li>
                                <a @click="changerView('departements')"><img src="@/assets/department.png"
                                        alt="Départements">
                                    Départements</a>
                            </li>
                            <li>
                                <a @click="changerView('entreprises')"><img src="@/assets/department.png"
                                        alt="Entreprises">
                                    Entreprises</a>
                            </li>
                        </ul>
                ...
                <div class="liste-post col-md-9 content" style="width: 80%;">
                    <FormationD></FormationD>
                </div>
                <div class="liste-post col-md-9">
...
import FormationD from "@/components/Dashboard/FormationDetail.vue"
