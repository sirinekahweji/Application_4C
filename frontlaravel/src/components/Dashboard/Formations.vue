    ...
    <div class=" modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            <label for="message" class="form-label">Description De l'Evenement</label>
    ...
    <div class="filter-bar">
      <div class="filter-bar">
        <div class="search-container">
          ...
          <input type="text" class="search-input" placeholder="Chercher Formation..." v-model="searchQuery">
        </div>
        <div class="bt">
        ...
        <div class="buttons-right">
          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-plus-circle"></i> Ajouter Formation</button>
        </div>
      </div>
    </div>
    <div class="card-container">
      <event v-for="(card, index) in displayedItems" :key="index" :name="card.titre" :affiche="card.affiche" />
    </div>
