...
export default {
  ...
  methods: {
    ParticiperUser(){
      Formations4csServices.Participer(this.user.id, this.idFormation);
      this.GetParticipation();
    },
    AnnulerParticiper(){
      Formations4csServices.AnnulerParticiper(this.user.id, this.idFormation).then(()=>{
        this.GetParticipation();
      });
    },
    GetParticipation() {
      Formations4csServices.GetParticipation(this.user.id, this.idFormation).then(res => {
