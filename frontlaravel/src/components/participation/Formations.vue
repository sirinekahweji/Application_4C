  ...
  <div>
    <div class="container">
      ...
      <div class="card-container">
        <event v-for="(card, index) in displayedItems" :id="card.id" :key="index" :name="card.titre" :affiche="card.affiche" />
      </div>
...
<script>
import event from '@/components/Dashboard/dashboard/formation.vue'
...
export default {
  ...
  methods: {
    ...
    getFormations() {
      Formations4cService.getFormation4cDisponible().then((res) => {
        this.cards = res.data;
      })
      Formations4cService.getFormation4cNonDisponible().then((res) => {
