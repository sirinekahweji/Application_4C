...
export default {
  ...
  methods: {
    ParticiperUser(){
      Certificat4cService.Participer(this.user.id, this.idCertif);
      this.GetParticipation();
    },
    AnnulerParticiper(){
      Certificat4cService.AnnulerParticiper(this.user.id, this.idCertif).then(()=>{
        this.GetParticipation();
      });
    },
    GetParticipation() {
      Certificat4cService.GetParticipation(this.user.id, this.idCertif).then(res => {
