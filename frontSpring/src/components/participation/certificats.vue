  ...
  <div>
    <div class="container">
      ...
      <div class="card-container">
        <event v-for="(card, index) in displayedItems" :key="index" :id="card.id" :name="card.nom" :affiche="card.certificat" />
      </div>
...
<script>
import event from '@/components/Dashboard/dashboard/certif.vue'
