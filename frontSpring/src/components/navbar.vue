    ...
    <div class="nav-bar">
      ...
      <div class="darkLight-searchBox affiche">
        <a href="#" class="notification-link">
          <img src="@/assets/notification_3602342.png" style="width: 23px; height: 23px;">
        </a>
        <div class="searchBox">
        ...
        <ul class="dropdown-menu">
          ...
          <li v-if="user.user_type === 'administrateur' || user.user_type === 'responsablemanager'">
            <hr class="dropdown-divider">
          </li>
          <li v-if="user.user_type === 'administrateur' || user.user_type === 'responsablemanager'"><router-link
