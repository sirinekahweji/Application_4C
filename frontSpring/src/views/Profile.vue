    ...
    <div v-if="view == 'profile'">
        ...
        <div class="container-fluid">
            <div class="cover-container">
                ...
                <img @click="openFullScreenImage(getPhotoCouverture())" :src="getPhotoCouverture()" alt="couverture"
                    class="cover-image">
                <button>
            ...
            <div class="nom">
                <h5>{{ this.user.nom }} <span> {{ this.user.prenom }}</span></h5>
                ...
                <p>{{ this.user.adresse }} <a href="#">Modifier</a></p>
            </div>
        </div>
                ...
                <div>
                    ...
                    <ul class="info">
                        <div>
                            ...
                            <li v-if="this.user.user_type === 'Enseignant'"><strong>Etablissement :</strong> {{
        this.enseignant.etablissement }}</li>
                            <li v-if="this.user.user_type === 'Etudiant'"><strong>Etablissement :</strong> {{
        this.etudiant.etablissement }}</li>
                            <li v-if="this.user.user_type === 'Etudiant'"><strong>Specialite :</strong>{{
        this.specialite.nom }}</li>
                            <li v-if="this.user.user_type === 'PersonnelEntreprise'"> <strong>Fonctionnalite :</strong>
                        ...
                        <div>
                            ...
                            <li v-if="this.user.user_type === 'Etudiant' || this.user.user_type === 'Enseignant'">
                                <strong>Departement :</strong> {{ this.departement.nom }}
                            </li>
                            <li v-if="this.user.user_type === 'Etudiant'"><strong>Classe :</strong>{{ this.classe.nom }}
                            </li>
                            <li v-if="this.user.user_type === 'PersonnelEntreprise'"><strong>Entreprise :</strong> {{
        this.entreprise.nom }}</li>
                            <li><strong>Adresse :</strong> {{ this.user.adresse }}</li>
                            <li><strong>LinkedIn :</strong> {{ this.user.lienLinkdIn }}</li>
                        </div>
                    </ul>
                    <div class="personnel">
...
export default {
    mounted() {
        ...
        console.log(this.user.photoProfile)
        this.getProfil();
