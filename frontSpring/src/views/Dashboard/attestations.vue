                    ...
                    <div class=" modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Ajouter Attestation</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form @submit.prevent="addAttestation">
                                    <div class="row">
                                        <!-- Partie gauche du formulaire -->
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="nom" class="form-label">Nom d'Attestation</label>
                                                <input v-model="attestation.nom" type="text" class="form-control"
                                                    id="nom" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" v-model="attestation.type" class="form-control"
                                                    id="lieu" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="image-container-choix">
                                        <div class="image-wrapper-choix">
                                            ...
                                            <input id="image1" type="radio" v-model="attestation.choix"
                                        ...
                                        <div class="image-wrapper-choix">
                                            ...
                                            <input id="image2" type="radio" v-model="attestation.choix"
                                        ...
                                        <div class="image-wrapper-choix">
                                            ...
                                            <input id="image3" type="radio" v-model="attestation.choix"
                                                name="image-choice" value="3">
                                        </div>
                                        <div class="image-wrapper-choix">
                                            <div class="image-content">
                                                <label for="image4"><img class="img-choix" :src="imagePath4"
                                                        alt="Image 1"></label>
                                                <i class="bi bi-zoom-in" @click="openFullScreenImage(imagePath4)"></i>
                                            </div>
                                            <input id="image4" type="radio" v-model="attestation.choix"
                                                name="image-choice" value="4">
                                        </div>
                                    </div>
                                    <div>
                                        <label for="message" class="form-label">Description De Attestation</label>
                                        <textarea class="form-control" v-model="attestation.description" id="message"
                                            rows="3"></textarea>
                                    </div>
                    ...
                    <div class="filter-bar">
                        <div class="filter-bar">
                            <div class="search-container">
                                ...
                                <input type="text" class="search-input" placeholder="Chercher Attestation..."
                                    v-model="searchQuery">
                            </div>
                            <!--<div class="bt">
              ...
              <button class="filter-button" @click="filtrerDonnees()"><i class="bi bi-funnel"></i> Filtrer</button>
                            ...
                            <div class="buttons-right">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    ...
                                    <i class="bi bi-plus-circle"></i> Ajouter Attestation
                                </button>
                            </div>
                        </div>
                    </div>
...
import event from '@/components/Dashboard/dashboard/attestation.vue'
...
export default {
    data() {
        return {
            ...
            itemsPerPage: 9,
            currentPage: 1,
            imagePath1: require('@/assets/Attestation/Bleu beige doré Classique Certificat de concours Diplôme.png'),
            imagePath2: require('@/assets/Attestation/Gold & Blue Modern Achievement Certificate.png'),
            imagePath3: require('@/assets/Attestation/Blue Gold Minimalist Certificate Of Appreciation Certificate.png'),
            imagePath4: require('@/assets/Attestation/Red and Gold Minimal Certificate Template.png'),
            attestation: {
                nom: null,
                type: null,
                description: null,
    ...
    methods: {
        addAttestation() {
            if (this.attestation.choix == 1) {
                this.attestation.image="assets/Attestation/Bleu beige doré Classique Certificat de concours Diplôme.png";
            }
            else if (this.attestation.choix == 2) {
                this.attestation.image="assets/Attestation/Gold & Blue Modern Achievement Certificate.png";
            }
            else if (this.attestation.choix == 3) {
                this.attestation.image="assets/Attestation/Blue Gold Minimalist Certificate Of Appreciation Certificate.png";
            }
            else if (this.attestation.choix == 4) {
                this.attestation.image="assets/Attestation/Red and Gold Minimal Certificate Template.png";
            }
            attestationService.addAttestation(this.attestation).then(()=>{
        ...
        filtrerDonnees() {
            if (!this.selectedCategory) {
                this.cards = this.getAttestations();
            } else {
                this.cards = this.cards.filter(attestation => attestation.type === this.selectedCategory);
            }
        },
        recherche() {
            if (this.searchQuery === '') {
        ...
        getAttestations() {
            attestationService.getAll().then((res) => {
