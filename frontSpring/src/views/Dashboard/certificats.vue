                    ...
                    <div class=" modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form @submit.prevent="addNewCertificat">
                                    <div class="row">
                                        <!-- Partie gauche du formulaire -->
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="nom" class="form-label">Nom de Certificat</label>
                                                <input type="text" v-model="certif.nom" class="form-control" id="nom"
                                                    required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="date" class="form-label">Date</label>
                                                <input type="date" v-model="certif.date" class="form-control" id="date"
                                                    required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="dateLimiteInscription" class="form-label">Date Limite
                                                    Inscription</label>
                                                <input type="date" v-model="certif.dateLimiteInscription"
                                                    class="form-control" id="dateLimiteInscription" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="certificat" class="form-label">Certificat</label>
                                                <input type="file" class="form-control" id="certificat" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="organisation" class="form-label">Organisation</label>
                                                <input type="text" v-model="certif.organisation" class="form-control"
                                                    id="organisation" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="message" class="form-label">Description De
                                                    l'Evenement</label>
                                                <textarea class="form-control" v-model="certif.description" id="message"
                                                    rows="3"></textarea>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" v-model="certif.lieu" class="form-control" id="lieu"
                                                    required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="capacite" class="form-label">Capacite </label>
                                                <input type="text" v-model="certif.capacite" class="form-control"
                                                    id="capacite" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="prix" class="form-label">Prix </label>
                                                <input type="text" v-model="certif.prix" class="form-control" id="prix"
                                                    required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="offre" class="form-label">Offre </label>
                                                <input type="text" v-model="certif.offre" class="form-control"
                                                    id="offre" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="categorie" class="form-label">Categorie </label>
                                                <input type="text" v-model="certif.categorie" class="form-control"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input type="radio" id="categorieInput0" value="1"
                                                        v-model="certif.forManagers" class="form-check-input">
                    ...
                    <div class="filter-bar">
                        <div class="filter-bar">
                            <div class="search-container">
                                ...
                                <input type="text" class="search-input" placeholder="Chercher Certificat..."
                                    v-model="searchQuery">
                            </div>
                            <div class="bt">
                            ...
                            <div class="buttons-right">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal"><i class="bi bi-plus-circle"></i> Ajouter
                                    Certificat</button>
                            </div>
                        </div>
                    </div>
...
import event from '@/components/Dashboard/dashboard/certifAdmin.vue'
...
export default {
    ...
    methods: {
        addNewCertificat() {
            ...
            const imageFiles = document.getElementById("certificat").files;
            if (imageFiles.length > 0) {
                const reader = new FileReader();
                const file = imageFiles[0]; // Select the first file from the list
                reader.readAsDataURL(file);

                reader.onload = (e) => {
                    const imageSrc = e.target.result;
                    this.certif.certificat = imageSrc;
                    //console.log(this.certif);

                    // Once the image data is read, call the service to add the certificat
                    Certificat4cService.addCertificat4c(this.certif).then(() => {
                        this.certif = {
                            nom: null,
                            lieu: null,
                            affiche: null,
        ...
        getCertificats() {
            Certificat4cService.getCertificat4cDisponible().then((res) => {
                this.cards = res.data;
            })
            Certificat4cService.getCertificat4cNonDisponible().then((res) => {
