<template>
    <div>
        <navBar></navBar>
        <section>
            <div class="wrapper mode-mobile">
                <div class="row" style="margin-right: 0px;">
                    <div class="left col-md-3" v-if="isHidden" @click="toggleVisibility">
                        <div class="top">
                            <input type="text" placeholder="Search" />
                            <a href="javascript:;" class="search"></a>
                        </div>
                        <PeopleList :people="people" @person-selected="setActivePerson" :activePerson="activePerson">
                        </PeopleList>
                    </div>
                    <ChatMessages :people="people[activePerson]" :chats="chats" :isHidden="isHidden"
                        @toggle-visibility="toggleVisibility" @refreche="refreche">
                    </ChatMessages>
                </div>
            </div>
            <div class="wrapper mode-pc">
                <div class="row" style="margin-right: 0px;">
                    ...
                    <ChatMessages @refreche="refreche" :people="people[activePerson]" :chats="chats"></ChatMessages>
                </div>
            </div>
        </section>
    </div>
...
import PeopleList from "@/components/discussion/PeopleList.vue";
import ChatMessages from "@/components/discussion/ChatMessages.vue";
            ...
            people: [
                {
                    ...
                    "cin": null,
                    "code_qr": "null",
                    "photoProfile": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5uoCTwDY557z4hT0K_pIY0gA3LyeNEprGmASpFupdXA&s",
    ...
    methods: {
        ...
        getMessages() {
            if (this.activePerson != 0) {
                discussionServices.getMessages(13, this.people[this.activePerson].id).then((res) => {
                    this.chats = res.data;
                }).catch((error) => {
                    console.error('Error fetching messages:', error);
                });
